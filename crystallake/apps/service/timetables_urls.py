...
from .views import create_timetable_view, edit_timetable_view, delete_timetable_view, get_timetable_info_view
...
urlpatterns = [
    ...
    path('delete_timetable/<int:timetable_id>/', delete_timetable_view, name='delete_timetable'),
