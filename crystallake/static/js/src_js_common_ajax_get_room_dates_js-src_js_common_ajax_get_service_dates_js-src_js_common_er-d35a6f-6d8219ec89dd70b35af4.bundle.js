...
__webpack_require__(/*! ../evo-calendar/evo-starter */ "./src/js/common/evo-calendar/evo-starter.js");
...
/***/ "./src/js/common/ajax/get_service_dates.js":
/*!*************************************************!*\
  !*** ./src/js/common/ajax/get_service_dates.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
...
;(function(factory) {
    ...
    ****************/
    ...
    // v1.0.0 - Select year
    EvoCalendar.prototype.selectYear = function(event, additional_info = {}) {
        var _ = this;
        var el, yearVal;
        ...
        $(_.$elements.calendarEl).trigger("selectYear", [_.$active.year, additional_info])
...
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
// import './evo-calendar'
__webpack_require__(/*! ./evo-calendar */ "./src/js/common/evo-calendar/evo-calendar.js");
$(document).ready(function(){
